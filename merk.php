...
$authErr = "";
$auth = false;
$q = "SELECT id, nama, keterangan FROM merk";
    ...
    <div class="hero">
        <div class="contable">
            ...
            <div class="button-container">
                <a href="config/crud/merk/create.php" class="btn">Tambah Merk</a>
                    ...
                    ?>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href='config/crud/merk/edit.php?id=<?= $rows["id"]; ?>' class='btn'>Edit</a>
                                    <a href='config/crud/merk/delete.php?id=<?= $rows["id"]; ?>' class='btn btn-delete' onclick='return confirm("Are you sure?")'>Delete</a>
                                </td>
                            </tr>
                    <?php
                        }
